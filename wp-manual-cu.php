...
Hey there! We're rolling out a faster, more streamlined repository experience and would love to give you early access.
 Unwatch 11
  Star 1
 Fork 0 BenjaminMedia/wp-manual-cu
 Branch: master  wp-manual-cu/wp-manual-cu.php
072c0fa  a day ago
@Xayer Xayer Fixed bug in wp-manual-cu
2 contributors @Xayer @skipperbent
RawBlameHistory     386 lines (309 sloc)  16.8 KB
<?php
/*
...
<div class="bonnier-wrapper">
    <div class='banner visible-md visible-lg'>
        <script type='text/javascript' src="http://eas4.emediate.eu/eas?cu=$desktopMiddle;cre=mu;js=y;pageviewid=;target=_blank" + EAS_pageviewid + "target=_blank" + eas.hlp.getCxProfileCookieData()></script>
    </div>
    <div class='banner visible-sm'>
        <script type='text/javascript' src="http://eas4.emediate.eu/eas?cu=$tabletMiddle;cre=mu;js=y;pageviewid=;target=_blank" + EAS_pageviewid + "target=_blank" + eas.hlp.getCxProfileCookieData()></script>
    </div>
    <div class='banner visible-xs'>
        <script type='text/javascript' src="http://eas4.emediate.eu/eas?cu=$mobileMiddle;cre=mu;js=y;pageviewid=;target=_blank" + EAS_pageviewid + "target=_blank" + eas.hlp.getCxProfileCookieData()></script>
    </div>
</div>
HTML;
    global $postCount;
